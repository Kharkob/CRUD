//put html snippet here
let html= (strings, ...values) => strings.reduce((acc, str, i) => acc + str + (values[i] || ""),"");
...
//what is $? its been used the curly brackets to signify that this is Javascript used very rarely
// also used to call ajax in like the ancient tagia link.
class HouseService {
...
class DOMManager {
    ...
    static deleteHouse(id) {
        ...
        //were starting back at return when we come back Sat
    static addRoom(id) {
    ...
    static render(houses) {
        ...
        for (let house of houses) {
            ...
            for (let room of house.rooms) {
                $(`#${house._id}`).find('.card-body').append(html`
                     <p>
